...
#ifndef MINHAGENT_IOS_SWIFT_H
#define MINHAGENT_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MinhAgent_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MinhAgent_iOS11AppDelegate")
...
@class UIScene;
SWIFT_CLASS("_TtC13MinhAgent_iOS13SceneDelegate")
